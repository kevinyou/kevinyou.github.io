...
\begin{rSection}{PERSONAL PROJECTS}
	...
	\begin{itemize}
		\itemsep -3pt {}
		\item Mastodon bot to share active 911 calls from City of Dallas open dataset in real-time
        \item Written in Typescript and run on AWS Lambda every minute
	\end{itemize}
\end{rSection}
